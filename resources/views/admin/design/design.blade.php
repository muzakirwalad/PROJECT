...
@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="/design/create" class="btn btn-primary">Tambah disign</a>
    </div>
    <hr />
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <form action="/design/{{ $item->id }}" method="POST" class="btn btn-danger p-0" onsubmit="return confirm('Yakin?')">
                                    @csrf
                                    @method('DELETE')
